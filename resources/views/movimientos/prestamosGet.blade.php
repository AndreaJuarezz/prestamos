    ...
    <table class="table" id="maintable">
        <thead>
            <tr>
                ...
                <th scope="col">FECHA INICIO DESCUENTIO</th>
        ...
        <tbody>
            @foreach($prestamos as $prestamo)
                <tr>
                    ...
                    <td class="text-right">{{$prestamo->monto}}</td>
                    <td class="text-center">{{$prestamo->plazo}}</td>
                    <td class="text-center">{{$prestamo->fecha_aprob}}</td>
                    <td class="text-right">{{$prestamo->tasa_mensual}}</td>
                    <td class="text-right">{{$prestamo->pago_fijo_cap}}</td>
                    <td class="text-center">{{$prestamo->fecha_ini_desc}}</td>
                    <td class="text-right">{{$prestamo->fecha_fin_desc}}</td>
                    <td class="text-right">{{$prestamo->saldo_actual}}</td>
